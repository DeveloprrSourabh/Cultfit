                          ...
                          <form action="" className="fir1">
                            <form action="" className="fir2">
                                  ...
                                  <div className="twochij">
                                    ...
                                    <div className="bhgjvkl">
                                      <button className="dollbtn">
                                        <img
                                          src="https://static.cure.fit/assets/images/male-active.svg"
                                          alt=""
                                          className="srcfghj"
                                        />
                                      </button>
                                      <button className="admijdjd">
                                        <img
                                          src="https://static.cure.fit/assets/images/female-inactive.svg"
                                          alt=""
                                          className="srcadi"
                                        />
                                      </button>
                              ...
                              <div className="lastformfur">
                                <label htmlFor="" className="ksiisk">
                                  EMAIL
                                </label>
